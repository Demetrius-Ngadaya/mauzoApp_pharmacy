...
$select_sql = "SELECT * FROM stock WHERE store_id = '$store_id' and expire_date <= '$current_date' ORDER BY expire_date ASC";
...
<div style="margin-top: 20px;">
    <table class="table table-bordered">
        <tr style="background-color: #f2f2f2;">
            <td><b>Jumla ya Dawa zilizo expire ni :<?php echo $total_remain_quantity;?></b></td>
