  ...
  <div class="content-wrapper">
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">
                 <b>  Mauzo yaliyofanyika mwezi wa nne mbaka wa sita</b> </h3>
              </div>
              <!-- /.card-header -->
    ...
    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
        ...
        <tbody>
            ...
            // Construct the SQL query to retrieve sales data from January to March
            $select_sql = "SELECT * FROM sales 
                           WHERE Date >= '$currentYear-04-01' AND Date <= '$currentYear-06-31'";
            ...
            if (mysqli_num_rows($select_query) > 0) {
                ...
                echo '<tr><td colspan="7">Hakuna mauzo yaliyofanyika  mwezi wa nne mbaka wa sita</td></tr>';
            }
            ?>
        </tbody>
    </table>
