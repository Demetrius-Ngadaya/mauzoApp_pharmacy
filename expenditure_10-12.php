          ...
          <div class="col-12">
            ...
            <div class="card">
              ...
              <div class="col-sm-6">	
                ...
                <h3 class="card-title">
                 <b>  Matumizi yaliyofanyika mwezi kumi mbaka wa kumi na mbili</b> </h3>
              </div>
...
// Construct the SQL query to retrieve expenditure data from October to December
$query = mysqli_query($con,"SELECT * FROM expenditure WHERE created_at >= '$currentYear-10-01' AND created_at <= '$currentYear-12-31'") or die(mysqli_error($con));
