        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Muuzaji</a></li>
            ...
            <div class="hero-unit-table">   
                            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    ...
                                    $query = mysqli_query($con,"select * from expenditure where store_id = '$store_id'") or die(mysqli_error());
                                    while ($row = mysqli_fetch_array($query)) {
                                      $id = $row['expenditure_id'];
										
																
										$query1 = mysqli_query($con,"SELECT *FROM expenditure where store_id = '$store_id'");
										

                                        ?>
                                        <tr class="warning">
                                            <td><?php echo $row['expenditure_name']; ?></td> 
                                            <td><?php echo number_format($row['expenditure_amount']); ?></td> 
