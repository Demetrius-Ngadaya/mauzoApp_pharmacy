        ...
        <div class="content-wrapper">
                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card">
                                    ...
                                    <!-- /.card-header -->
                                    <h3 class="card-title">
                                            <b> Grafu ikionesha mauzo yaliyofanyika kuanzia mwezi wa kwanza mbaka wa kumi na mbili</b>
                                        </h3>
                                    <div class="card-body">
                                        ...
                                        $select_sql = "SELECT DATE_FORMAT(Date, '%Y-%m') AS Month, SUM(total_amount) AS TotalAmount 
               FROM sales                
            ...
            <script>
                ...
                var salesChart = new Chart(ctx, {
                    ...
                    data: {
                        labels: months, // Remove labels for pie chart
                        datasets: [{
                            label: 'Jumla kiasi cha mauzo',
                            data: totalAmounts,
                            backgroundColor: [
                                'rgba(255, 99, 132, 0.5)',
                                'rgba(54, 162, 235, 0.5)',
