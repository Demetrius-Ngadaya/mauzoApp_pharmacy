...
$profit_amt = $profit*$qty;
 $insert_sql ="INSERT INTO on_hold values('','$invoice_number','$medicine_name','$category','$expire_date','$qty','$sell_type','$cost','$amount','$discounted_price', '$payment_method','$phone_number','$date_to_pay','$profit_amt','$date','$status', '$store_id')";//*****INSERTING INTO on_HOLD TABLE*******
