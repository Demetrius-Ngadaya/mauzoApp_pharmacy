    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            ...
            <div class="card">
              ...
              <div class="card-header">
                <h3 class="card-title">
                 <b>  Dawa Zinazokaribia kuisha</b> </h3>
              </div>
          ...
          $max_quantity = 9; // Maximum quantity
          $select_sql= "SELECT * FROM stock WHERE store_id = '$store_id' AND act_remain_quantity <= stock_alert AND act_remain_quantity > 0 AND status = 'Available'";
    	  ...
    	  ?>
    	  	<tr>
    	  		...
    	  		<td>Dawa zimebaki chini ya <?php echo $row['stock_alert']?></td>
