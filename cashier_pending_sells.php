                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                            <div class="card-header">
                                <h3 class="card-title"><b>Mauzo yasiyokamilika</b></h3>
                            </div>
...
$select_sql = "SELECT oh.* FROM on_hold oh
               ...
               WHERE s.medicines IS NULL and store_id = '$store_id'";
...
if (mysqli_num_rows($select_query) > 0) {
    ...
    while ($row = mysqli_fetch_assoc($select_query)) {
        ...
        echo '<td>
            <a href="cashierPOS.php?invoice_number='.$row['invoice_number'].'" class="btn btn-primary btn-sm">
