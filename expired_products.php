        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Dawa zilizo expire</li> -->
            </ol>
          </div>
        </div>
      </div>
          ...
          <div class="col-12">
            ...
            <div class="card">
              ...
              <div class="card-header">
                <h3 class="card-title">
                 <b> Dawa zilizoisha mda wa matumizi </b> </h3>
              </div>
...
$select_sql = "SELECT * FROM stock WHERE store_id = '$store_id' and expire_date <= '$current_date' AND act_remain_quantity!=0 ORDER BY expire_date ASC";
$result = mysqli_query($con, $select_sql);
$total_act_remain_quantity = 0;
...
while ($row = mysqli_fetch_array($result)):
    $total_act_remain_quantity += $row['act_remain_quantity'];
    $total_actual_price += $row['actual_price'] * $row['act_remain_quantity'];
?>
<tr>
    <td><?php echo $serial_number++; ?></td> <!-- Display the serial number -->
    <td><?php echo $row['medicine_name']?></td>
    <td><font color="red"><?php echo $row['expire_date']?></font></td>
    <td><?php echo $row['act_remain_quantity']."(".$row['sell_type'].")"?></td>
    <td><?php echo number_format($row['actual_price'])?> Tsh</td>
    <td><?php echo number_format( $row['actual_price']*$row['act_remain_quantity'])?> Tsh</td>
</tr>
<?php endwhile;?>
</tbody>
</table>
...
<div style="margin-top: 20px;">
    <table class="table table-bordered">
        <tr style="background-color: #f2f2f2;">
            <td><b>Jumla ya Dawa zilizo expire ni :<?php echo $total_act_remain_quantity;?></b></td>
