    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <tr style="background-color: #383838; color: #FFFFFF;" >
          ...
          $select_sql= "SELECT * FROM stock WHERE store_id = '$store_id'and act_remain_quantity > '$min_quantity' AND act_remain_quantity <= '$max_quantity' AND status = 'Available'";
