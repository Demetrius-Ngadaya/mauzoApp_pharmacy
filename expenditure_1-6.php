          ...
          <div class="col-12">
            ...
            <div class="card">
              ...
              <div class="col-sm-6">	
                ...
                <h3 class="card-title">
                 <b>  Matumizi yaliyofanyika mwezi wa nne mbaka wa nne</b> </h3>
              </div>
              <!-- /.card-header -->
...
// Construct the SQL query to retrieve expenditure data from April to June
$query = mysqli_query($con,"SELECT * FROM expenditure WHERE created_at >= '$currentYear-01-01' AND created_at <= '$currentYear-06-30'") or die(mysqli_error($con));
