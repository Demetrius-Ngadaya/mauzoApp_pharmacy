          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">
                 <b>  Mauzo yaliyofanyika wiki hii   </b> </h3>
              </div>
              <!-- /.card-header -->
...
$select_sql = "SELECT * FROM sales WHERE Date BETWEEN '$currentWeekStart' AND '$currentWeekEnd'";
...
if (mysqli_num_rows($select_query) > 0) {
    ...
    echo '<tr><td colspan="6">Hakuna mauzo yaliyofanyika hii.</td></tr>';
}
?>
