  ...
  <div class="content-wrapper">
    <section class="content-header">
      <div class="container-fluid"> 
        <div class="row mb-2">
          <div class="col-sm-12">			
            <b>Ripoti ya manunuziya Dawa kwa mkopo tokana na tarehe ya kulipa</b>						
          </div>
          <div class="col-sm-12">
            <ol class="breadcrumb float-sm-right">
            <li class="nav-item">
              <strong>Admin/Ripoti</A></strong>
      </li>
      <!-- <li class="nav-item">
    ...
    <section class="content">
      ...
      <div class="form-group">
        <label for="created_by" class="sr-only">Aliyerodi:</label>
      ...
      <div class="form-group">
        <label for="status" class="sr-only">Hali malipo:</label>
