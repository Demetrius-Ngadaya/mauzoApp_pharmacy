...
<?php include('indexSideBar.php') ?>
  ...
  <div class="content-wrapper">
    ...
    <a href="hamisha_bure.php?invoice_number=<?php echo $_GET['invoice_number']?>" style="color: white; text-decoration: none;">Rifresh</a>
</button>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <center>
                <div class="col-md-12">
       <form method="POST" action="insert_invoice_hamisha_bure.php?invoice_number=<?php echo $_GET['invoice_number']?> " style="display: flex; flex-wrap: wrap; gap: 10px;">
...
<!--                      
           ...
           <td><a href="delete_invoice_hamisha_bure.php?invoice_number=<?php echo $_GET['invoice_number']?>&id=<?php echo $row['id'];?>&name=<?php echo $row['medicine_name']?>&expire_date=<?php echo $row['expire_date']?>&quantity=<?php echo $row['qty'];?>" class="btn btn-danger">Ondoa</a></td>
          ...
          <?php
           if($medicine_name && $category && $quantity !=null){
            ...
            <a id="popup" href="checkout_hamisha_bure.php?invoice_number=<?php echo $_GET['invoice_number']?>&medicine_name=<?php echo $medicine_name?>&category=<?php echo $category?>&ex_date=<?php echo $ex_date?>&quantity=<?php echo $quantity?>&total=<?php echo $grand_total?>&profit=<?php echo $grand_profit?>" style="width:400px;" class="btn btn-info btn-large">Chagua tawi/kituo</i></a>
