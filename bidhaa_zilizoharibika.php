          ...
          <div class="col-12">
            ...
            <div class="card">
              ...
              <div class="card-header">
                <h3 class="card-title">
                 <b>  Orodha ya Dawa mbovu au zilizo expire zilizorudishwa na mteja   </b> </h3>
              </div>
...
if (mysqli_num_rows($select_query) > 0) {
    ...
    while ($row = mysqli_fetch_assoc($select_query)) {
        ...
        echo "<td>" . number_format($row['returned_amount'] ). "</td>";
    ...
    echo '<tr><td colspan="6">No product returned.</td></tr>';
}
?>
