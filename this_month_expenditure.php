  ...
  <div class="content-wrapper">
          ...
          <div class="col-12">
            ...
            <div class="card">
              ...
              <div class="col-sm-6">	
                ...
                <h3 class="card-title"><b>  Matumizi yaliyofanyika  mwezi huu</b> </h3>
              </div>
              <!-- /.card-header -->
    ...
    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
        ...
        <tbody>
            ...
            // Construct the SQL query to retrieve expenditure data for the current month
            $query = mysqli_query($con,"SELECT * FROM expenditure WHERE YEAR(created_at) = YEAR(CURRENT_DATE()) AND MONTH(created_at) = MONTH(CURRENT_DATE())") or die(mysqli_error($con));
            $serialNumber = 1;
