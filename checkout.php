        ...
        $(document).ready(function() {
                    ...
                    success: function(response) {
                        ...
                        try {
                            ...
                            if (data.status === "success") {
                                ...
                                // Redirect to home.php after successful sale
                                window.location.href = "home.php?invoice_number=" + data.new_invoice_number;
                            } else {
                    ...
                    success: function(response) {
                        ...
                        try {
                            ...
                            if (data.status === "success") {
                                ...
                                // Redirect to home.php with the new invoice number
                                window.location.href = "home.php?invoice_number=" + data.new_invoice_number;
                            } else {
                                alert("Hitilafu: " + data.message);
                            }
            ...
            $("#closeForm").click(function() {
                if (window.opener) {
                    ...
                    // If the window was not opened by another window, generate a new invoice number and redirect to home.php
                    $.ajax({
                        type: "POST",
                        url: "save_invoice.php",
