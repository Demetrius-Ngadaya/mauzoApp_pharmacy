  ...
  <div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Expire alert</li>
            </ol>
          </div>
        </div>
      </div>
    ...
    <table class="table table-bordered">
        <tr style="background-color: #f2f2f2;">
            <td><b>Total medicine  expire alert : <?php echo $total_remain_quantity; ?></b></td>
            <td><b>Medicine value: Tsh <?php echo $total_actual_price; ?></b></td>
        </tr>
    </table>
</div>
