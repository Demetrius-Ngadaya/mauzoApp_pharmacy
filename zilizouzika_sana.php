          ...
          <div class="col-12">
            ...
            <div class="card">
              ...
              <div class="card-header">
                <h3 class="card-title">
                 <b>  Dawa zilizouzika sana(idadi zaidi ya 50)   </b> </h3>
              </div>
...
GROUP BY stock.id, stock.medicine_name, stores.location
...
if (mysqli_num_rows($select_query) > 0) {
    ...
    echo '<tr><td colspan="6">Hakuna Dawa zilizouzika sana kwa idadi ya zaidi ya 50.</td></tr>';
}
?>
