  ...
  <div class="content-wrapper">
    <section class="content-header">
      <div class="container-fluid"> 
        <div class="row mb-2">
          <div class="col-sm-6">	
            <b>Ripoti mauzo ya mkopo yakionesha mauzo ya mkopo yaliyolipwa</b>	
          </div>
          <div class="col-sm-6">
    ...
    <section class="content">
      ...
      <div class="form-group">
        <label for="medicine" class="sr-only">Jina ka Dawa:</label>
        ...
        <button class="btn btn-info" type="submit" name="submit"><i class="icon icon-search icon-large"></i> Tafuta</button>
                          ...
                          <div style="overflow-x:auto; overflow-y: auto;">
                            <table class="table table-bordered table-striped table-hover">
                              ...
                              JOIN stores ON sales.store_id = stores.id WHERE (paid_date BETWEEN '$d1' AND '$d2') AND (payment_method='credit') AND (hali_ya_malipo='paid') ";
                                if (!empty($created_by)) {
                              ...
                              <?php } else {
                                $date = date('Y-m-d');
                                $select_sql = "SELECT sales.*, stores.location FROM sales 
                              JOIN stores ON sales.store_id = stores.id WHERE paid_date = '$date' AND payment_method ='credit' AND hali_ya_malipo='paid' ";
                                $select_query = mysqli_query($con, $select_sql);
                              ...
                              <tbody>
                                <tr> 
                                  ...
                                  <td><?php echo $row['invoice_number']?></td>
                                  <td><?php echo $row['payment_method']?></td>
                                  <td><?php echo $row['hali_ya_malipo']?></td>                                  <td><?php echo $row['phone_number']?></td>
                                  <td><?php echo $row['phone_number']?></td>
                                  <td><?php echo $row['date_to_pay']?></td>
