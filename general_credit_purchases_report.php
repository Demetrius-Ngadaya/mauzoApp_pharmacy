  ...
  <div class="content-wrapper">
    <section class="content-header">
      <div class="container-fluid"> 
        <div class="row mb-2">
          <div class="col-sm-12">	
            <b>Repoti ya jumla ya Dawa zilizonunuliwa kwa mkopo(zilizolipwa na ambazo bado)</b>						
          </div>
          <div class="col-sm-6">
    ...
    <section class="content">
                  ...
                  <div class="row">
                    <div class="col-12">
                      <div class="card">
                        <div class="card-header">
                          <center>
                          <form action="general_credit_purchases_report.php?invoice_number=<?php echo $_GET['invoice_number']?>" method="POST" class="form-inline">
      ...
      <div class="form-group">
        ...
        <input type="text" id="created_by" name="created_by" class="form-control" placeholder="Jina la aliyerokodi" autocomplete="off">
      </div>
      <div class="form-group">
                          ...
                          <div style="overflow-x:auto; overflow-y: auto;">
                            <table class="table table-bordered table-striped table-hover">
                              ...
                              if(isset($_POST['submit'])){
                                ...
                                $select_sql = "SELECT * FROM purchases_report WHERE (received_date BETWEEN '$d1' AND '$d2')  AND (status!='cash') ";
                                if (!empty($created_by)) {
                              ...
                              <?php } else {
                                $date = date('Y-m-d');
                                $select_sql = "SELECT * FROM purchases_report WHERE received_date = '$date'  AND status !='cash' ";
                                $select_query = mysqli_query($con, $select_sql);
