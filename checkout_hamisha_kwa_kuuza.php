    ...
    <script>
        $(document).ready(function() {
            ...
            $("#saveSales").click(function(e) {
                ...
                $.ajax({
                    type: "POST",
                    url: "save_invoice_hamisha_kwa_kuuza.php",
                    data: $("form").serialize(),
                    success: function(response) {
                        ...
                        try {
                            ...
                            if (data.status === "success") {
                                alert("Mizani imetumwa kikamilifu!");
                                window.location.href = "hamisha_kwa_kuuza.php?invoice_number=" + data.new_invoice_number;
                            } else {
