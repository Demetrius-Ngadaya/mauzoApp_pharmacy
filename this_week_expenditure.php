          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">
                 <b>  Matumizi yaliyofanyika wiki hii</b> </h3>
              </div>
              <!-- /.card-header -->
            ...
            <div class="hero-unit-table">   
                            <table class="table table-striped table-bordered table-responsive table-hover" id="dataTables-example">
                               ...
                               $currentWeekEnd = date('Y-m-d', strtotime('sunday this week'));
                                    ...
                                    // Construct the SQL query to retrieve sales data for today only
                                    $query = mysqli_query($con,"select * from expenditure WHERE  created_at  BETWEEN '$currentWeekStart' AND '$currentWeekEnd'") or die(mysqli_error());
