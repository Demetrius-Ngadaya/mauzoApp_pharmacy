  ...
  <div class="content-wrapper">
    <section class="content-header">
      <div class="container-fluid"> 
        <div class="row mb-2">
          <div class="col-sm-6">	
            <b>Ripoti ya mauzo kwa mkopo tokana na siku yakuuza Dawa</b>						
          </div>
          <div class="col-sm-6">
                  ...
                  <div class="row">
                    <div class="col-12">
                      <div class="card">
                        <div class="card-header">
                          <center>
                          <form action="ripoti _mauzo_ya_mkopo.php?invoice_number=<?php echo $_GET['invoice_number']?>" method="POST" class="form-inline">
        ...
        <button class="btn btn-info" type="submit" name="submit"><i class="icon icon-search icon-large"></i> Tafuta</button>
                          ...
                          <div style="overflow-x:auto; overflow-y: auto;">
                            <table class="table table-bordered table-striped table-hover">
                              ...
                              JOIN stores ON sales.store_id = stores.id WHERE (Date BETWEEN '$d1' AND '$d2') AND (payment_method='credit') AND (hali_ya_malipo='not paid') ";
                                if (!empty($created_by)) {
                              ...
                              <?php } else {
                                $date = date('Y-m-d');
                                $select_sql = "SELECT sales.*, stores.location FROM sales 
                              JOIN stores ON sales.store_id = stores.id WHERE Date = '$date' AND payment_method ='credit' AND (hali_ya_malipo='not paid') ";
                                $select_query = mysqli_query($con, $select_sql);
                            ...
                            <center>
                              ...
                              <a href="export_excel.php?d1=<?php echo $d1; ?>&d2=<?php echo $d2; ?>&created_by=<?php echo $created_by; ?>&medicine=<?php echo $medicine; ?>&category=<?php echo $category; ?>&store_location=<?php echo $store_location; ?>" class="btn btn-success">Pakua katika Excel</a>
                                <a href="export_ripoti_mkopo1_pdf.php?d1=<?php echo $d1; ?>&d2=<?php echo $d2; ?>&created_by=<?php echo $created_by; ?>&medicine=<?php echo $medicine; ?>&category=<?php echo $category; ?>&store_location=<?php echo $store_location; ?>" class="btn btn-danger">Pakua katika PDF</a>
                              </div>
                            </center>
                          </div>
                        </div>
