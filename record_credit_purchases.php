  ...
  <div class="content-wrapper">
    <section class="content-header">
      <div class="container-fluid"> 
        <div class="row mb-2">
          <div class="col-sm-6">	
            <p>Orodha ya Dawa zote, futa au badili taharifa ya Dawa</p>
            <?php
...
<script type="text/javascript">
    ...
    <div class="card-header">
     ...
     <!-- <a href="create_product.php?invoice_number=<?php echo $_GET['invoice_number']?>" id="popup"><button class="btn btn-success btn-md" name="submit"><span class="icon-plus-sign icon-large"></span> Unda Dawa mpya</button></a> -->
    ...
    <section class="content">
     ...
     <div class="container"><!---****SEARCHES_CONTENT*****--->
      ...
      <div class="row">
            ...
            <input type="text" size="20" id="med_quantity" onkeyup="quanti()" placeholder="andika jina la Dawa" title="andika jina la Dawa"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
      ...
      <div class="col-12">
        <form method="POST">
          ...
          <tr style="background-color: #383838; color: #FFFFFF;" >
             ...
             <!-- <th style="background-color: #383838;" width="1%">Tarehe ya ku Expire</th> -->
             <th width="2%">Bei kununulia</th>
             <th width="2%">Bei kuuzia</th>
             <th width="2%">Profit</th>
             <!-- <th width = "3%">Status</th> -->
             <th width = "5">Rekodi manunuzi kwa mkopo</th>
             <!-- <th width = "5">Futa</th> -->
             </tr>
           </thead>
           <tbody>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header bg-primary">
        <h5 class="modal-title text-white" id="editProductModalLabel">  <i>Ingiza manunuzi ya Dawa kwa mkopo </i></h5>
