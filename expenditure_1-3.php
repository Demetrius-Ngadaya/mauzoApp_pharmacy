          ...
          <div class="col-12">
            ...
            <div class="card">
              ...
              <div class="col-sm-6">	
                ...
                <h3 class="card-title">
                 <b>  Matumizi yaliyofanyika mwezi wa kwanza mbaka wa tatu</b> </h3>
              </div>
              <!-- /.card-header -->
...
// Construct the SQL query to retrieve expenditure data from January to March
$query = mysqli_query($con,"SELECT * FROM expenditure WHERE created_at >= '$currentYear-01-01' AND created_at <= '$currentYear-03-31'") or die(mysqli_error($con));
