  ...
  <div class="content-wrapper">
    <section class="content-header">
      <div class="container-fluid"> 
        <div class="row mb-2">
          <div class="col-sm-12">	
            <b>Ripoti ya manunuzi kwa mkopo tokana na tarehe deni la mkopo lililipwa</b>		
          </div>
          <div class="col-sm-6">
    ...
    <section class="content">
                  ...
                  <div class="row">
                    <div class="col-12">
                      <div class="card">
                        <div class="card-header">
                          <center>
                          <form action="credit_purchases_paid_credit_report.php?invoice_number=<?php echo $_GET['invoice_number']?>" method="POST" class="form-inline">
      ...
      <div class="form-group">
        <label for="created_by" class="sr-only">Aliyerekodi:</label>
      ...
      <div class="form-group">
        <label for="company" class="sr-only">Msambazaji:</label>
                          ...
                          <div style="overflow-x:auto; overflow-y: auto;">
                            <table class="table table-bordered table-striped table-hover">
                              ...
                              if(isset($_POST['submit'])){
                                ...
                                $select_sql = "SELECT * FROM purchases_report WHERE (paid_date BETWEEN '$d1' AND '$d2')  AND (status='paid') ";
                                if (!empty($created_by)) {
                              ...
                              <?php } else {
                                $date = date('Y-m-d');
                                $select_sql = "SELECT * FROM purchases_report WHERE paid_date = '$date'  AND status='paid' ";
                                $select_query = mysqli_query($con, $select_sql);
                              ...
                              <tbody>
                                <tr> 
                                  ...
                                  <td><?php echo $row['credit_amount']?></td> <!-- New column -->
                                  <td><?php echo $row['date_to_pay']?></td> <!-- New column -->
                                  <td><?php echo $row['paid_date']?>&nbsp;&nbsp;(<font size='2' color='#009688;'>Today</font>)</td>
                                  <td><?php echo $row['receipt_number']?></td>
                                  <td><?php echo $row['batch_number']?></td>
                                  <td><?php echo $row['company']?></td>
                                  <td><?php echo $row['created_by']?></td>
