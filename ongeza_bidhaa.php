...
$sql = "SELECT id, medicine_name, category, quantity, used_quantity, remain_quantity, act_remain_quantity, actual_price, selling_price, profit_price, register_date, expire_date, edited_by, edited_date, store_id
...
<head>
    ...
    <!-- link rel="stylesheet" type="text/css" href="../css/bootstrap-responsive.css"
      this link inafanya modal ya kuingiza Dawa ifunguke beyond modal form -->
...
$sql = "SELECT id, bar_code, medicine_name, category, quantity, used_quantity, remain_quantity, act_remain_quantity, register_date, expire_date, company, sell_type, actual_price, selling_price, profit_price, edited_by, edited_date, status, store_id  FROM stock WHERE store_id = '$store_id' ORDER BY id ";
  $result = mysqli_query($con, $sql); ?>
