...
if (isset($_POST['sale_id']) && isset($_POST['invoice_number'])) {
 ...
 $update_sql = "UPDATE sales SET hali_ya_malipo = 'paid', paid_date = '$currentDate' , credit_payment_recorder='$current_user' WHERE id = '$sale_id'";
 ...
 if (mysqli_query($con, $update_sql)) {
    ...
    echo "Sale ID or invoice number not provided.";
}
?>
